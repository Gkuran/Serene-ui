...
export const SofaDonation: Story = {
  args: {
    ...
    description:
      "Sofá de couro marrom, usado mas bem conservado. Ideal para sala de estar. Retirada no bairro Centro.",
...
export const TableDonation: Story = {
  args: {
    ...
    description:
      "Mesa de madeira com algumas marcas de uso, acompanha 4 cadeiras. Perfeita para quem está começando.",
    publishDate: "Ontem",
    status: "reserved",
  },
};
    ...
    children: (
      <View>
        ...
        <Text style={{ color: "#666" }}>
          Você ainda pode usar o card com conteúdo totalmente customizado.
        </Text>
      </View>
    ),
  },
...
export const BooksDonation: Story = {
  args: {
    ...
    description:
      "Livros do ensino médio em ótimo estado. Matemática, Português, História e Ciências. Podem ajudar estudantes.",
